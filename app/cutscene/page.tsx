...
import IntroStage, { LogoImage } from "@/components/intro/IntroStage";
import "@/components/intro/cutscene.css";
...
/**
 * /cutscene — standalone showcase of the boot intro with replay.
 * The same IntroStage also plays site-wide via BootIntroGate (root layout).
 */
  ...
  return (
    <main className="cs-root">
      ...
      <IntroStage
        ...
        endContent={<EndFrame onReplay={replay} />}
      />
    </main>
  );
}
