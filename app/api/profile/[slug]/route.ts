...
getNestedValue(profileData, ["Currency", "Diamonds", "Value"]),
getNestedValue(profileData, ["Currency", "Diamonds", "count"]),
getNestedValue(profileData, ["Currency", "Diamonds", "Count"]),
...
goldenPetsEquipped,
rainbowPetsEquipped,
ultimate: String(getNestedValue(inventoryData, ["equipped", "ultimate", "displayName"]) ?? "—"),
hoverboard: String(getNestedValue(inventoryData, ["equipped", "hoverboard", "displayName"]) ?? "—"),
booth: String(getNestedValue(inventoryData, ["equipped", "booth", "displayName"]) ?? "—"),
};
}
